...
- Add a method to respond to the URL scheme. This is just an example of a method that you can add at the bottom of you file if you're using both `FBSDKApplicationDelegate` and `RNGoogleSignin` (don't forget to remove the old code of `FBSDKApplicationDelegate` if you already added it) :
